...
class KafkaProducerCallable implements Callable<String> {
    ...
    KafkaProducerCallable(DailyMeetingMessageHandler dailyHandler) {
    ...
    public String call() throws Exception {
        ...
        try {
            ...
            while (DailyMeetingMessageHandler.keepRunning.get()) {
                while ((request = dailyHandler.requestQueue.poll()) != null) {
